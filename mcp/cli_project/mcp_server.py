...
@mcp.tool(
    ...
    description="Read the contents of a doocument and return it as a string."
)
...
def edit_document(
    ...
    old_string: str = Field(description="The text to replace. Must match exactly includeing white space"),
